...
export default function About() {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      {/* Hero Section */}
      <section className="relative h-[60vh] w-full overflow-hidden flex items-center justify-center pt-32 bg-black">
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto text-white">
          <motion.h1 
            ...
            className="text-5xl md:text-7xl font-serif mb-6 text-white text-shadow-lg leading-tight"
          >
            Our Heritage
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-white/90 font-normal text-shadow-md max-w-2xl mx-auto"
          >
